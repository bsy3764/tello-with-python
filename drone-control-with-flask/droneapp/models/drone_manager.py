# droneapp/models/drone_manager.py
...
# OpenCV Haar로 얼굴 인식하기 위한 XML파일을 변수에 할당
...
# OpenCV Haar로 얼굴 인식하기 위한 XML파일이 있는지 체크하는 클래스
...
class DroneManager(metaclass=Singleton):    # 싱글톤 사용하기
    def __init__(self, host_ip='192.168.10.2', host_port=8889,
       ...
       # 순찰 실행 여부 판단할 변수
        ...
        if not os.path.exists(FACE_DETECT_XML_FILE):    # OpenCV Haar XML파일이 없다면
